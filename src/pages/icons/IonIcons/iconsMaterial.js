...
export default [
  ...
  { icon: MdAlbums, name: "MdAlbums" },
  { icon: MdAlert, name: "MdAlert" },
  { icon: MdAmericanFootball, name: "MdAmericanFootball" },
  { icon: MdAnalytics, name: "MdAnalytics" },
  { icon: MdAperture, name: "MdAperture" },
  { icon: MdApps, name: "MdApps" },
  { icon: MdAppstore, name: "MdAppstore" },
  { icon: MdArchive, name: "MdArchive" },
  { icon: MdArrowBack, name: "MdArrowBack" },
  { icon: MdArrowDown, name: "MdArrowDown" },
  { icon: MdArrowDropdown, name: "MdArrowDropdown" },
  { icon: MdArrowDropdownCircle, name: "MdArrowDropdownCircle" },
  { icon: MdArrowDropleft, name: "MdArrowDropleft" },
  { icon: MdArrowDropleftCircle, name: "MdArrowDropleftCircle" },
  { icon: MdArrowDropright, name: "MdArrowDropright" },
  { icon: MdArrowDroprightCircle, name: "MdArrowDroprightCircle" },
  { icon: MdArrowDropup, name: "MdArrowDropup" },
  { icon: MdArrowDropupCircle, name: "MdArrowDropupCircle" },
  { icon: MdArrowForward, name: "MdArrowForward" },
  { icon: MdArrowRoundBack, name: "MdArrowRoundBack" },
  { icon: MdArrowRoundDown, name: "MdArrowRoundDown" },
  { icon: MdArrowRoundForward, name: "MdArrowRoundForward" },
  { icon: MdArrowRoundUp, name: "MdArrowRoundUp" },
  { icon: MdArrowUp, name: "MdArrowUp" },
  { icon: MdAt, name: "MdAt" },
  { icon: MdAttach, name: "MdAttach" },
  { icon: MdBackspace, name: "MdBackspace" },
  { icon: MdBarcode, name: "MdBarcode" },
  { icon: MdBaseball, name: "MdBaseball" },
  { icon: MdBasket, name: "MdBasket" },
  { icon: MdBasketball, name: "MdBasketball" },
  { icon: MdBatteryCharging, name: "MdBatteryCharging" },
  { icon: MdBatteryDead, name: "MdBatteryDead" },
  { icon: MdBatteryFull, name: "MdBatteryFull" },
  { icon: MdBeaker, name: "MdBeaker" },
  { icon: MdBeer, name: "MdBeer" },
  { icon: MdBicycle, name: "MdBicycle" },
  { icon: MdBluetooth, name: "MdBluetooth" },
  { icon: MdBoat, name: "MdBoat" },
  { icon: MdBody, name: "MdBody" },
  { icon: MdBonfire, name: "MdBonfire" },
  { icon: MdBook, name: "MdBook" },
  { icon: MdBookmark, name: "MdBookmark" },
  { icon: MdBookmarks, name: "MdBookmarks" },
  { icon: MdBowtie, name: "MdBowtie" },
  { icon: MdBriefcase, name: "MdBriefcase" },
  { icon: MdBrowsers, name: "MdBrowsers" },
  { icon: MdBrush, name: "MdBrush" },
  { icon: MdBug, name: "MdBug" },
  { icon: MdBuild, name: "MdBuild" },
  { icon: MdBulb, name: "MdBulb" },
  { icon: MdBus, name: "MdBus" },
  { icon: MdCafe, name: "MdCafe" },
  { icon: MdCalculator, name: "MdCalculator" },
  { icon: MdCalendar, name: "MdCalendar" },
  { icon: MdCall, name: "MdCall" },
  { icon: MdCamera, name: "MdCamera" },
  { icon: MdCar, name: "MdCar" },
  { icon: MdCard, name: "MdCard" },
  { icon: MdCart, name: "MdCart" },
  { icon: MdCash, name: "MdCash" },
  { icon: MdChatboxes, name: "MdChatboxes" },
  { icon: MdChatbubbles, name: "MdChatbubbles" },
  { icon: MdCheckbox, name: "MdCheckbox" },
  { icon: MdCheckboxOutline, name: "MdCheckboxOutline" },
  { icon: MdCheckmark, name: "MdCheckmark" },
  { icon: MdCheckmarkCircle, name: "MdCheckmarkCircle" },
  { icon: MdCheckmarkCircleOutline, name: "MdCheckmarkCircleOutline" },
  { icon: MdClipboard, name: "MdClipboard" },
  { icon: MdClock, name: "MdClock" },
  { icon: MdClose, name: "MdClose" },
  { icon: MdCloseCircle, name: "MdCloseCircle" },
  { icon: MdClosedCaptioning, name: "MdClosedCaptioning" },
  ...
  { icon: MdCloudOutline, name: "MdCloudOutline" },
  { icon: MdCloudUpload, name: "MdCloudUpload" },
  { icon: MdCloudy, name: "MdCloudy" },
  { icon: MdCloudyNight, name: "MdCloudyNight" },
  { icon: MdCode, name: "MdCode" },
  { icon: MdCodeDownload, name: "MdCodeDownload" },
  { icon: MdCodeWorking, name: "MdCodeWorking" },
  { icon: MdCog, name: "MdCog" },
  { icon: MdColorFill, name: "MdColorFill" },
  { icon: MdColorFilter, name: "MdColorFilter" },
  { icon: MdColorPalette, name: "MdColorPalette" },
  { icon: MdColorWand, name: "MdColorWand" },
  { icon: MdCompass, name: "MdCompass" },
  { icon: MdConstruct, name: "MdConstruct" },
  { icon: MdContact, name: "MdContact" },
  { icon: MdContacts, name: "MdContacts" },
  { icon: MdContract, name: "MdContract" },
  { icon: MdContrast, name: "MdContrast" },
  { icon: MdCopy, name: "MdCopy" },
  { icon: MdCreate, name: "MdCreate" },
  { icon: MdCrop, name: "MdCrop" },
  { icon: MdCube, name: "MdCube" },
  { icon: MdCut, name: "MdCut" },
  { icon: MdDesktop, name: "MdDesktop" },
  { icon: MdDisc, name: "MdDisc" },
  { icon: MdDocument, name: "MdDocument" },
  { icon: MdDoneAll, name: "MdDoneAll" },
  { icon: MdDownload, name: "MdDownload" },
  { icon: MdEasel, name: "MdEasel" },
  { icon: MdEgg, name: "MdEgg" },
  { icon: MdExit, name: "MdExit" },
  { icon: MdExpand, name: "MdExpand" },
  { icon: MdEye, name: "MdEye" },
  { icon: MdEyeOff, name: "MdEyeOff" },
  { icon: MdFastforward, name: "MdFastforward" },
  { icon: MdFemale, name: "MdFemale" },
  { icon: MdFiling, name: "MdFiling" },
  { icon: MdFilm, name: "MdFilm" },
  { icon: MdFingerPrint, name: "MdFingerPrint" },
  { icon: MdFlag, name: "MdFlag" },
  { icon: MdFlame, name: "MdFlame" },
  { icon: MdFlash, name: "MdFlash" },
  { icon: MdFlask, name: "MdFlask" },
  { icon: MdFlower, name: "MdFlower" },
  { icon: MdFolder, name: "MdFolder" },
  { icon: MdFolderOpen, name: "MdFolderOpen" },
  { icon: MdFootball, name: "MdFootball" },
  { icon: MdFunnel, name: "MdFunnel" },
  { icon: MdGameControllerA, name: "MdGameControllerA" },
  { icon: MdGameControllerB, name: "MdGameControllerB" },
  { icon: MdGitBranch, name: "MdGitBranch" },
  { icon: MdGitCommit, name: "MdGitCommit" },
  { icon: MdGitCompare, name: "MdGitCompare" },
  { icon: MdGitMerge, name: "MdGitMerge" },
  { icon: MdGitNetwork, name: "MdGitNetwork" },
  { icon: MdGitPullRequest, name: "MdGitPullRequest" },
  { icon: MdGlasses, name: "MdGlasses" },
  { icon: MdGlobe, name: "MdGlobe" },
  { icon: MdGrid, name: "MdGrid" },
  { icon: MdHammer, name: "MdHammer" },
  { icon: MdHand, name: "MdHand" },
  { icon: MdHappy, name: "MdHappy" },
  { icon: MdHeadset, name: "MdHeadset" },
  { icon: MdHeart, name: "MdHeart" },
  { icon: MdHeartOutline, name: "MdHeartOutline" },
  { icon: MdHelp, name: "MdHelp" },
  { icon: MdHelpBuoy, name: "MdHelpBuoy" },
  { icon: MdHelpCircle, name: "MdHelpCircle" },
  { icon: MdHome, name: "MdHome" },
  { icon: MdIceCream, name: "MdIceCream" },
  { icon: MdImage, name: "MdImage" },
  { icon: MdImages, name: "MdImages" },
  { icon: MdInfinite, name: "MdInfinite" },
  { icon: MdInformation, name: "MdInformation" },
  { icon: MdInformationCircle, name: "MdInformationCircle" },
  { icon: MdIonic, name: "MdIonic" },
  { icon: MdIonitron, name: "MdIonitron" },
  { icon: MdJet, name: "MdJet" },
  { icon: MdKey, name: "MdKey" },
  { icon: MdKeypad, name: "MdKeypad" },
  { icon: MdLaptop, name: "MdLaptop" },
  { icon: MdLeaf, name: "MdLeaf" },
  { icon: MdLink, name: "MdLink" },
  { icon: MdList, name: "MdList" },
  { icon: MdListBox, name: "MdListBox" },
  { icon: MdLocate, name: "MdLocate" },
  { icon: MdLock, name: "MdLock" },
  { icon: MdLogIn, name: "MdLogIn" },
  { icon: MdLogOut, name: "MdLogOut" },
  { icon: MdMagnet, name: "MdMagnet" },
  { icon: MdMail, name: "MdMail" },
  { icon: MdMailOpen, name: "MdMailOpen" },
  { icon: MdMale, name: "MdMale" },
  { icon: MdMan, name: "MdMan" },
  { icon: MdMap, name: "MdMap" },
  { icon: MdMedal, name: "MdMedal" },
  { icon: MdMedical, name: "MdMedical" },
  { icon: MdMedkit, name: "MdMedkit" },
  { icon: MdMegaphone, name: "MdMegaphone" },
  { icon: MdMenu, name: "MdMenu" },
  { icon: MdMic, name: "MdMic" },
  { icon: MdMicOff, name: "MdMicOff" },
  { icon: MdMicrophone, name: "MdMicrophone" },
  { icon: MdMoon, name: "MdMoon" },
  { icon: MdMore, name: "MdMore" },
  { icon: MdMove, name: "MdMove" },
  { icon: MdMusicalNote, name: "MdMusicalNote" },
  { icon: MdMusicalNotes, name: "MdMusicalNotes" },
  { icon: MdNavigate, name: "MdNavigate" },
  { icon: MdNoSmoking, name: "MdNoSmoking" },
  { icon: MdNotifications, name: "MdNotifications" },
  { icon: MdNotificationsOff, name: "MdNotificationsOff" },
  { icon: MdNotificationsOutline, name: "MdNotificationsOutline" },
  { icon: MdNuclear, name: "MdNuclear" },
  { icon: MdNutrition, name: "MdNutrition" },
  { icon: MdOpen, name: "MdOpen" },
  { icon: MdOptions, name: "MdOptions" },
  { icon: MdOutlet, name: "MdOutlet" },
  { icon: MdPaper, name: "MdPaper" },
  { icon: MdPaperPlane, name: "MdPaperPlane" },
  { icon: MdPartlySunny, name: "MdPartlySunny" },
  { icon: MdPause, name: "MdPause" },
  { icon: MdPaw, name: "MdPaw" },
  { icon: MdPeople, name: "MdPeople" },
  { icon: MdPerson, name: "MdPerson" },
  { icon: MdPersonAdd, name: "MdPersonAdd" },
  { icon: MdPhoneLandscape, name: "MdPhoneLandscape" },
  { icon: MdPhonePortrait, name: "MdPhonePortrait" },
  { icon: MdPhotos, name: "MdPhotos" },
  { icon: MdPie, name: "MdPie" },
  { icon: MdPin, name: "MdPin" },
  { icon: MdPint, name: "MdPint" },
  { icon: MdPizza, name: "MdPizza" },
  { icon: MdPlane, name: "MdPlane" },
  { icon: MdPlanet, name: "MdPlanet" },
  { icon: MdPlay, name: "MdPlay" },
  { icon: MdPodium, name: "MdPodium" },
  { icon: MdPower, name: "MdPower" },
  { icon: MdPricetag, name: "MdPricetag" },
  { icon: MdPricetags, name: "MdPricetags" },
  { icon: MdPrint, name: "MdPrint" },
  { icon: MdPulse, name: "MdPulse" },
  { icon: MdQrScanner, name: "MdQrScanner" },
  { icon: MdQuote, name: "MdQuote" },
  { icon: MdRadio, name: "MdRadio" },
  { icon: MdRadioButtonOff, name: "MdRadioButtonOff" },
  { icon: MdRadioButtonOn, name: "MdRadioButtonOn" },
  { icon: MdRainy, name: "MdRainy" },
  { icon: MdRecording, name: "MdRecording" },
  { icon: MdRedo, name: "MdRedo" },
  { icon: MdRefresh, name: "MdRefresh" },
  { icon: MdRefreshCircle, name: "MdRefreshCircle" },
  ...
  { icon: MdResize, name: "MdResize" },
  { icon: MdRestaurant, name: "MdRestaurant" },
  { icon: MdReturnLeft, name: "MdReturnLeft" },
  { icon: MdReturnRight, name: "MdReturnRight" },
  { icon: MdReverseCamera, name: "MdReverseCamera" },
  { icon: MdRewind, name: "MdRewind" },
  { icon: MdRibbon, name: "MdRibbon" },
  { icon: MdRose, name: "MdRose" },
  { icon: MdSad, name: "MdSad" },
  ...
  { icon: MdShareAlt, name: "MdShareAlt" },
  { icon: MdShirt, name: "MdShirt" },
  { icon: MdShuffle, name: "MdShuffle" },
  { icon: MdSkipBackward, name: "MdSkipBackward" },
  { icon: MdSkipForward, name: "MdSkipForward" },
  { icon: MdSnow, name: "MdSnow" },
  { icon: MdSpeedometer, name: "MdSpeedometer" },
  { icon: MdSquare, name: "MdSquare" },
  { icon: MdSquareOutline, name: "MdSquareOutline" },
  { icon: MdStar, name: "MdStar" },
  { icon: MdStarHalf, name: "MdStarHalf" },
  { icon: MdStarOutline, name: "MdStarOutline" },
  { icon: MdStats, name: "MdStats" },
  { icon: MdStopwatch, name: "MdStopwatch" },
  { icon: MdSubway, name: "MdSubway" },
  { icon: MdSunny, name: "MdSunny" },
  { icon: MdSwap, name: "MdSwap" },
  { icon: MdSwitch, name: "MdSwitch" },
  { icon: MdSync, name: "MdSync" },
  { icon: MdTabletLandscape, name: "MdTabletLandscape" },
  { icon: MdTabletPortrait, name: "MdTabletPortrait" },
  { icon: MdTennisball, name: "MdTennisball" },
  { icon: MdText, name: "MdText" },
  { icon: MdThermometer, name: "MdThermometer" },
  { icon: MdThumbsDown, name: "MdThumbsDown" },
  { icon: MdThumbsUp, name: "MdThumbsUp" },
  { icon: MdThunderstorm, name: "MdThunderstorm" },
  { icon: MdTime, name: "MdTime" },
  { icon: MdTimer, name: "MdTimer" },
  { icon: MdTrain, name: "MdTrain" },
  { icon: MdTransgender, name: "MdTransgender" },
  { icon: MdTrash, name: "MdTrash" },
  { icon: MdTrendingDown, name: "MdTrendingDown" },
  { icon: MdTrendingUp, name: "MdTrendingUp" },
  { icon: MdTrophy, name: "MdTrophy" },
  { icon: MdUmbrella, name: "MdUmbrella" },
  { icon: MdUndo, name: "MdUndo" },
  { icon: MdUnlock, name: "MdUnlock" },
